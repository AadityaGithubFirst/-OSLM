...
```
As it can be seen that term_units and zterm_units_ZofZ are both having a lot of null value we could drop these two rows. This is there being around 634 observations and if we were to remove 147 rows of this data it could cause some problems as the size fo the dataset is already so small. 
