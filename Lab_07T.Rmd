...
```
```
From this it can be seen that group 0 has a higher difference from group 1 and group 2 but group 1 and group 2 does not have a high significantly differenct means.
```
